...
import '../pages/PhoneAppPage.css';

const ByonTruckingCompaniesPage = () => {
  return (
    <div className="phone-app-page">
      ...
      <section className="pa-hero">
        ...
        <div className="pa-hero-content">
          ...
          <h1 data-testid="byon-trucking-page-title">Secure Driver Communications</h1>
...
export default ByonTruckingCompaniesPage;
